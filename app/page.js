...
function SchoolFinderPage({ user, onLoginClick }) {
  ...
  function SchoolCard({ school, rank, isTop }) {
    ...
    return (<div onClick={function(){setSelectedSchool(school);}} style={{background:"white",borderRadius:14,padding:"18px 22px",border:isTop?"2px solid "+RED:"1px solid #E5E7EB",cursor:"pointer",transition:"all 0.2s",position:"relative",boxShadow:"0 1px 4px rgba(0,0,0,0.04)"}} onMouseEnter={function(e){e.currentTarget.style.boxShadow="0 6px 20px rgba(0,0,0,0.08)";e.currentTarget.style.transform="translateY(-2px)";}} onMouseLeave={function(e){e.currentTarget.style.boxShadow="0 1px 4px rgba(0,0,0,0.04)";e.currentTarget.style.transform="none";}}>
