...
const testimonialCategories = [
  { category: "Overall Journey", icon: "\u{1F31F}", items: [
    ...
    { name: "Vrinda Gupta", school: "ISB Co'26", image: "https://lbrcrknnivxkqvryzamr.supabase.co/storage/v1/object/public/testimonials/Testimonial%20Pictures/Vrinda1.jpeg", text: "I initially reached out to Tanya via LinkedIn for help with my ISB application essays, and the experience exceeded my expectations. Tanya's expertise in essay development helped me craft compelling narratives that truly reflected my experiences, while Manan's meticulous attention to resume structuring showcased my professional journey effectively. Their commitment, strategic insights, and detailed feedback were exceptional throughout the process. Beyond just application support, the learning experience was invaluable – I gained self-reflection skills and communication techniques. When I received my ISB interview call, their comprehensive interview preparation with mock sessions and targeted feedback proved remarkably similar to the actual interview experience, giving me the confidence to perform at my best. I am grateful for their support and would highly recommend them to anyone navigating the MBA application journey" },
    { name: "Sejal Taneja", school: "ISB Co'25", image: "https://lbrcrknnivxkqvryzamr.supabase.co/storage/v1/object/public/testimonials/Testimonial%20Pictures/Sejal.jpeg", text: "I’ve always felt that relying on alums is the most genuine way to prepare, there’s a sense of honesty and relatability you just don’t get with admission consulting agencies. From the start of my application process, I leaned heavily on advice from people who had been through it before. But when it came to interview prep, I was honestly lost. I wasn’t sure how to structure my story or even what parts of it were worth highlighting. I saw their post on LinkedIn and reached out. My first mock interview with Manan didn’t go great but that turned out to be a blessing. His detailed feedback gave me clear direction, and I followed it up with another mock with Tanya. That session helped me really dig into my story and understand how to present it better. Their guidance didn’t stop at just interview prep, they also helped me with my Resume and were always available for questions, even months after admissions. The feedback I got from Tanya especially helped during placement interviews as well. I’m super grateful to both of them for not just helping me with interviews but also the guidance through the ISB journey" },
